...
public class CreateTicketRequestWithoutCustomFields : IRequestWithAttachment
{
    public CreateTicketRequestWithoutCustomFields(TicketStatus status, TicketPriority priority, TicketSource source, string description, string? requesterName = null,
        ...
        DateTimeOffset? dueBy = null, long? emailConfigId = null,
