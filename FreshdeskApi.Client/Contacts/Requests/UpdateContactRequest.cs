...
{
    /// <summary>
    /// Defines the set of properties to update on a contact
    ///
    ...
    public class UpdateContactRequest
    {
        ...
        /// associated with the company to which he belong.
        /// </summary>
        ...
        /// can only be updated if the Multiple Companies feature is enabled
        ...
        /// can only be updated if the Multiple Language feature is enabled
        /// (Garden plan and above)
        /// </summary>
        ...
        /// domain. This attribute can only be updated if the Multiple Time
        /// Zone feature is enabled (Garden plan and above)
        /// </summary>
